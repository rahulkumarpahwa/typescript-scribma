...
// addToArray(orderQueue, { id: nextOrderId++, pizza: menu[2], status: "done" }) // there is bug that status: "ordered" | "completed" can be only be completed or ordered but here the done is putted in the value and typescript does not give any error. 
addToArray<Order>(orderQueue, { id: nextOrderId++, pizza: menu[2], status: "completed" }) // here we explicitly define the type of the data like we define in the generic. 
